...
export SSH_KEY=/Users/pieter/Kubernetes/ssh_key.pem
...
export CONTROLLER_PUBLIC_IPS=(52.205.176.236 52.90.112.45 34.205.63.108 54.157.54.59)
export CONTROLLER_PRIVATE_IPS=(172.31.56.108 172.31.53.202 172.31.51.88 172.31.60.168)

#export CONTROLLER_PUBLIC_IP=54.152.200.2

export CONTROLLER0_PUBLIC_IP=52.205.176.236
export CONTROLLER0_PRIVATE_IP=172.31.56.108
export CONTROLLER1_PUBLIC_IP=52.90.112.45
export CONTROLLER1_PRIVATE_IP=172.31.53.202

export WORKER0_PUBLIC_IP=34.205.63.108
export WORKER0_PRIVATE_IP=172.31.51.88
export WORKER1_PUBLIC_IP=54.157.54.59
export WORKER1_PRIVATE_IP=172.31.60.168

export WORKER_PUBLIC_IPS=(34.205.63.108 54.157.54.59)
export WORKER_PRIVATE_IPS=(172.31.51.88 172.31.60.168)

export KUBE_APISERVER_SERVICE_IP=10.200.0.1
export KUBE_DNS_SERVICE_IP=10.200.0.33

export CLUSTER_DOMAIN=pietercluster.local
...
export ETCD_SERVER_CERTREQ_CONFIG=/tmp/etcd_certreq.conf
